...
import { ArrowLeft, FileText, LogIn, ShieldCheck, Zap } from 'lucide-react'
        ...
        <div className="grid overflow-hidden rounded-[32px] bg-white shadow-2xl shadow-slate-900/20 lg:grid-cols-2">
          ...
          <div className="relative hidden flex-col justify-between overflow-hidden bg-slate-950 p-10 text-white lg:flex">
            ...
            <div className="relative mt-10">
              <h2 className="text-5xl font-semibold leading-[1.05] tracking-tight">Manage your invoices</h2>
          ...
          <div className="flex flex-col bg-white p-8 sm:p-12">
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/signup" className="inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 transition hover:text-slate-900">
                Sign Up
              </Link>
            </div>
              ...
              <div>
                ...
                <div className="mt-2 flex justify-end">
                  <Link
                    ...
                    className="text-xs font-medium text-red-500 transition duration-200 hover:text-red-600"
                  >
                    Forgot password?
                  </Link>
                </div>
